...
<body>
  ...
  <div class="container">
    ...
    <div class="tab-content ">
      ...
      <div class="row">
        <div class=" col-xs-12 col-sm-12 col-lg-9 col-md-9">
          ...
          $getdata = "select count(productID) as total from product where soluongbanduoc>=10 and categoryID=($id) ";
          $query1 = $mysqli->query($getdata);
          ...
          //lấy dữ liệu cho từng trang
          $sql = "select * from product WHERE (soluongbanduoc>=10 and categoryID=($id))  order by soluongbanduoc desc LIMIT $start, $limit";
          $query = $mysqli->query($sql);
          ...
          } else echo "<h4>Không có sản phẩm để hiển thị</h4>";
          ...
          <div class="col-md-12 col-sm-12 col-xs-12 hero-feature">
            <ul class="pager">
              ...
              if ($current_page > 1 && $total_page > 1) {
                echo '<li><a href="category.php?tab=1&page=' . ($current_page - 1) . '&idcatogory=' . ($id) . '">Trang trước</a></li>';
              }
              ...
              for ($i = 1; $i <= $total_page; $i++) {
                ...
                if ($i == $current_page) {
                  ...
                  echo '<li><a href="category.php?tab=1&page=' . $i . '&idcatogory=' . ($id) . '">' . $i . '</a></li>';
                }
              }
              ...
              if ($current_page < $total_page && $total_page > 1) {
                $mysqli->set_charset("utf8");
                echo '<li><a href="category.php?tab=1&page=' . ($current_page + 1) . '&idcatogory=' . ($id) . '">Trang sau</a></li>';
              }
              ?>
    ...
    <?php $id1 = isset($_GET['idcatogory']) ? $_GET['idcatogory'] : 1; ?>
    <?php
    ...
    <div class="row">
      <div class=" col-xs-12 col-sm-12 col-lg-9 col-md-9">
        ...
        $conn->set_charset("utf8");
        //lấy sản phẩm trong database
        $getdata = "select count(productID) as total from product where categoryID=$id1 and discount>0";
        ...
        //lấy dữ liệu cho từng trang
        $sqld = "select * from product where (categoryID=$id1 and discount>0)  order by discount desc LIMIT $start, $limit";
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 hero-feature">
          <ul class="pager">
            ...
            // nếu current_page > 1 và total_page > 1 mới hiển thị nút prev
            if ($current_page > 1 && $total_page > 1) {
              echo '<li><a href="category.php?tab=2&pagekm=' . ($current_page - 1) . '&idcatogory=' . ($id) . '">Trang trước</a></li>';
            }
            ...
            for ($i = 1; $i <= $total_page; $i++) {
              ...
              if ($i == $current_page) {
                ...
                echo '<li><a href="category.php?tab=2&pagekm=' . $i . '">' . $i . '&idcatogory=' . ($id) . '</a></li>';
              }
            }

            // nếu current_page < $total_page và total_page > 1 mới hiển thị nút prev
            if ($current_page < $total_page && $total_page > 1) {
              echo '<li><a href="category.php?tab=2&pagekm=' . ($current_page + 1) . '&idcatogory=' . ($id) . '">Trang sau</a></li>';
            }
            ?>
  ...
  ?>
  <?php $id2 = isset($_GET['idcatogory']) ? $_GET['idcatogory'] : 1; ?>
  <div class="row">
    <div class=" col-xs-12 col-sm-12 col-lg-9 col-md-9">
      <br><br>
      <!--1-->
      ...
      $conn->set_charset("utf8");
      //lấy sản phẩm trong database
      $getdata = "select count(productID) as total from product WHERE categoryID=$id2";
      $query1 = $mysqli->query($getdata);
      ...
      //lấy dữ liệu cho từng trang
      $sql = "select * from product WHERE categoryID=$id2 order by dateupdate desc LIMIT $start, $limit";
      $query = $mysqli->query($sql);
      ...
      <div class="col-md-12 col-sm-12 col-xs-12 hero-feature">
        <ul class="pager">
          ...
          // nếu current_page > 1 và total_page > 1 mới hiển thị nút prev
          if ($current_page > 1 && $total_page > 1) {
            echo '<li><a href="category.php?tab=3&pagen=' . ($current_page - 1) . '&idcatogory=' . ($id) . '">Trang trước</a></li>';
          }
          ...
          for ($i = 1; $i <= $total_page; $i++) {
            ...
            if ($i == $current_page) {
              ...
              echo '<li><a href="category.php?tab=3&pagen=' . $i . '">' . $i . '&idcatogory=' . ($id) . '</a></li>';
            }
          }

          // nếu current_page < $total_page và total_page > 1 mới hiển thị nút prev
          if ($current_page < $total_page && $total_page > 1) {
            echo '<li><a href="category.php?tab=3&pagen=' . ($current_page + 1) . '&idcatogory=' . ($id) . '">Trang sau</a></li>';
          }
          ?>
